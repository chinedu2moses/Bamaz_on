# Bamaz_on
The BamazonCustomer manages customer level purchase of products from a mysql database.

Below are the criteria and requirments for this project.
...
![image](https://github.com/chinedu2moses/Bamaz_on/blob/master/img/Capture.PNG)
